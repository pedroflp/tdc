    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          disabled: "border border-primary/15 bg-primary/10 text-primary/50 hover:bg-accent hover:text-accent-foreground",
      },
      size: {
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, loading, asChild = false, children, ...props }, ref) => {
    ...
    props.disabled || loading ? variant = "disabled" : variant
